...
*/
    ...
    /// Produce the numeric comparison between each metric and its global mean value.
    ///
    ///
    /// Precondition:
    ...
    auto compare_means(Eigen::VectorXd const& local_means, Eigen::VectorXd const& global_means) -> Eigen::VectorXd;
}
